        ...
        <el-card class="box-card">
          ...
          <div class="head-container">
            <div v-if="crud.props.searchToggle">
              <!-- 搜索 -->
              <el-input v-model="query.blurry" clearable size="small" placeholder="Enter a name or description to search" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
              <rrOperation />
            </div>
...
export default {
  ...
  cruds() {
    return [
      CRUD({ title: 'Dictionary', url: 'api/dict', crudMethod: { ...crudDict }})
    ]
  },
