<template>
    <div class="app-container">
        <el-button class="float-button" size="small" @click="handleBack" type="primary"><i class="el-icon-back" />
            Back</el-button>
        <div class="app-container">
            ...
            <div class="book_operation">
                <el-button v-if="isLogin" type="primary" size="mini" icon="el-icon-view" @click="handleRead">Read</el-button>
                <el-button v-else type="primary" size="mini" icon="el-icon-view" @click="handleRreview">Preview</el-button>
                <el-button v-if="isLogin" type="success" size="mini" icon="el-icon-star-on" :loading="collectLoading"
                @click="handleCollect">Collect</el-button>
                <el-button v-if="isLogin && !bookVo.hasBorrowed" :loading="borrowing" type="info" size="mini" icon="el-icon-sold-out" @click="handleBorrow">Borrow</el-button>
                <el-button v-if="isLogin && bookVo.hasBorrowed" :loading="borrowing" type="danger" size="mini" icon="el-icon-time" @click="handleReturn">Return</el-button>
        ...
        <el-button v-if="isLogin" class="float-button-comment" size="small" @click="handleComment" type="primary">Comment</el-button>
        ...
        <!--阅读器-->
        <media-reader v-if="bookVo.book != null" ref="mediaReader" :mediaType="bookVo.book.mediaType"
            :mediaUrl="bookVo.book.url" />
        <!-- 预览 -->
        <media-reader v-if="bookVo.book != null" ref="previewMediaReader" :mediaType="bookVo.book.mediaType"
            :mediaUrl="bookVo.book.sample" />
    </div>
</template>

<script>
import { getToken } from '@/utils/auth' // getToken from cookie
import { addBookComment, addToBookShelf, getBookCategoryDict, getBookDetail, borrowBook, returnBook } from '@/api/system/job'
...
export default {
    ...
    methods: {
        ...
        handleRreview() {
            this.$refs['previewMediaReader'].handleOpen()
        },

        handleBorrow() {
            let params = {
                userId: this.user.id,
                bookId: this.bookVo.book.id
            }
            this.borrowing = true
